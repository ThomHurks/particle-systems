...
struct MatrixBlock {
    ...
    MatrixBlock(const int ci, const int pi, const int ilength, const int jlength, double* const data[]) :
...
public:
    ...
    void AddNewBlock(const int ci, const int pi, const int ilength, const int jlength, double* const data[]);
private:
